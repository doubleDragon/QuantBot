...
class Arbitrage(BasicBot):
    ...
    btc > bt1 + bt2: 卖btc 买bt1 bt2
    btc < bt1 + bt2: 买btc 卖bt1 bt2

    btc_usd, bt1_usd, bt2_usd

    python -m quant.cli -mBitfinex_BTC_USD,Bitfinex_BT1_BTC,Bitfinex_BT2_BTC t-watch-bfx-btc -fbfx_btc.log -v
    """
