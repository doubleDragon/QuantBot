...
class TriangleArbitrage(BasicBot):
    """
    bch:
    python -m quant.cli -mBitfinex_BCH_USD,Binance_BCC_BTC,Bitfinex_BTC_USD t-watch-bfx-bn-bfx-usd-bch-btc -v


    neo:
    python -m quant.cli -mBitfinex_NEO_USD,Binance_NEO_BTC,Bitfinex_BTC_USD t-watch-bfx-bn-bfx-usd-neo-btc -v
    python -m quant.cli -mBitfinex_NEO_USD,Binance_NEO_ETH,Bitfinex_ETH_USD t-watch-bfx-bn-bfx-usd-neo-eth-v

    双bfx, 单bn
    python -m quant.cli -mBitfinex_NEO_BTC,Binance_NEO_ETH,Bitfinex_ETH_BTC t-watch-bfx-bn-bfx-btc-neo-eth -v
    python -m quant.cli -mBitfinex_NEO_BTC,Bitfinex_NEO_ETH,Binance_ETH_BTC t-watch-bfx-bfx-bn-btc-neo-eth -v
    python -m quant.cli -mBinance_NEO_BTC,Bitfinex_NEO_ETH,Bitfinex_ETH_BTC t-watch-bn-bfx-bfx-btc-neo-eth -v
    单bfx, 双bn
    python -m quant.cli -mBinance_NEO_BTC,Binance_NEO_ETH,Bitfinex_ETH_BTC t-watch-bn-bn-bfx-btc-neo-eth -v
    python -m quant.cli -mBinance_NEO_BTC,Bitfinex_NEO_ETH,Binance_ETH_BTC t-watch-bn-bfx-bn-btc-neo-eth -v
    python -m quant.cli -mBitfinex_NEO_BTC,Binance_NEO_ETH,Binance_ETH_BTC t-watch-bfx-bn-bn-btc-neo-eth -v
