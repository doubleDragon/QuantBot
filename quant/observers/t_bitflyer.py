...
class TriangleArbitrage(BasicBot):
    ...
    def __init__(self, base_pair, pair1, pair2, monitor_only=False, **kwargs):
        ...
        # 1usd =
        self.rate_usd_jpy = Rate().query('USD', 'JPY')
    ...
    def forward(self, depths):
        ...
        base_pair_ask_price = base_pair_ask_price * self.rate_usd_jpy
    ...
    def reverse(self, depths):
        ...
        base_pair_bid_price = base_pair_bid_price * self.rate_usd_jpy
