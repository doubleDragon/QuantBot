...
class Bittrex(object):
    ...
    def depth(self, symbol):
        resp = self.get_orderbook(symbol, depth_type='both')
        return resp
...
#     lle = len(data[u'bids'])
#     for i in range(lle):
#         price = data[u'bids'][i][u'Rate']
#         amount = data[u'bids'][i][u'Quantity']
#         bids.append(Item(price, amount))
#         price = data[u'asks'][i][u'Rate']
#         amount = data[u'asks'][i][u'Quantity']
